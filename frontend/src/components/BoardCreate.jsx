...
export const BoardCreate = ({ currentUser }) => {
    ...
    const handleCreateBoard = async (e) => {
        axiosInstance.post(`/board/create`, {user_id, title, body});
        navigate(`/boards`)
    }
    ...
    return (
        ...
        <div class="w-11/12 mx-auto py-20">
            ...
            <p>内容</p>
            <textarea name="" id="" cols="30" rows="5" class="border border-gray-200 rounded w-full mb-3" value={body} defaultValue="" onChange={(e) => setBody(e.target.value)} ></textarea>
            <p>タグ</p>
            <div class="flex">
