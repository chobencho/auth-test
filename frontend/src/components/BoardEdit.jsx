...
export const BoardEdit = ({ currentUser }) => {
    ...
    return (
        <div class="w-11/12 mx-auto my-3">
            ...
            <p>内容</p>
            <textarea name="" id="" cols="30" rows="5" class="border border-gray-200 rounded w-full mb-3" value={boardContent} key={boardData?.board_content} defaultValue={boardData?.board_content} onChange={(e) => setBoardContent(e.target.value)} ></textarea>
            <p>タグ</p>
            <div class="flex">
